app.controller('manager_dashboardCtrl', function ($scope, $http, $timeout, $window, $rootScope, $filter, $location) {
          $scope.img = profile;
          $scope.details = [];
          var token;
          ...
          $scope.showDetails = function (n) {
            ...
            window.location.href = 'bank-reciept-voucher.html?n='+ encryptData(JSON.stringify(nObject));
          }
