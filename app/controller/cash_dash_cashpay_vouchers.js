...
app.controller('cashDashCashPayVouCtrl', function ($scope, $http, $timeout, $window, $rootScope, $filter, $location) {
    $scope.details = [];
    ...
    $scope.searchFields = function (keyword1, keyword2, keyword3, keyword4, keyword5, payeeTypeCode, payFromTypeCode, payTo) {
      ...
      $http.post(path + '/api/v1/account/cpv/search', bankReceiptVoucherDto, config)
